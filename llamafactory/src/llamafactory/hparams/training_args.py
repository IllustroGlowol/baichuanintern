...
class TrainingArguments(RayArguments, Seq2SeqTrainingArguments):
    """
    Args:
        visual_lr (`float`, *optional*, defaults to 5e-5):
                The initial learning rate for visual [`AdamW`] optimizer.
    """
    visual_lr: float = field(default=5e-5, metadata={"help": "The initial learning rate for visual AdamW."})
